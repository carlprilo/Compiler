...
//        scrollPane.setPreferredSize(new Dimension(myWIDTH/3,3*myHEIGHT/5));//设置编辑框的大小
        ...
        editArea.setPreferredSize(new Dimension(myWIDTH/3,3*myHEIGHT/5));//设置编辑框的大小
        pack();



        //显示词法分析表的内容
        JPanel panel_east = new LexicalTable();
    ...
    class LexicalTable extends JPanel
    {
        ...
        public LexicalTable()
        {
            ...
            scrollPane2.setPreferredSize(new Dimension(myWIDTH/3-36,3*myHEIGHT/5));
    ...
    class DeductionTable extends JPanel
    {
        ...
        public DeductionTable()
        {
            ...
            JScrollPane scrollPane2 = new JScrollPane();
            scrollPane2.setViewportView(table);
            scrollPane2.setPreferredSize(new Dimension(2*myWIDTH/3-30,27*myHEIGHT/100));
            this.add(scrollPane2);
        }
    }
